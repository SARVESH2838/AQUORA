...
import SurfaceHistoryChart
  from "../components/SurfaceHistoryChart";
...
function Reports({
        ...
        <main className="reports-empty">
          ...
          <div className="reports-empty-card">
            ...
            <p>
              ...
              from Explore, retrieve
              available observations,
              and generate an AQUORA
              Ocean Evidence Report.
            ...
            <Link
              to="/"
              className="reports-explore-link"
            >
  ...
  const hasSurfaceData =
    report.surface.available;


  const hasArgoData =
    report.subsurfaceEvidence.available;


  const hasHistory =
    report.surfaceHistory?.available ??
    false;
  ...
  const gridPoint =
    ...
    report.surface.gridLongitude !== null
      ...
      ? `${report.surface.gridLatitude.toFixed(
          3
        )}°, ${report.surface.gridLongitude.toFixed(
          3
        )}°`
  ...
  const temperature =
    ...
    report.surface.temperatureC !== null
      ...
      ? `${report.surface.temperatureC.toFixed(
          2
        )} °C`
  ...
  const anomaly =
    ...
    report.surface.anomalyC !== null
      ...
      ? `${
          report.surface.anomalyC >
          0
            ? "+"
            : ""
        }${report.surface.anomalyC.toFixed(
          2
        )} °C`
            ...
            <div className="report-source-status-list">
              ...
              <div className="report-source-status">
                ...
                <div>
                  ...
                  <strong>
                    NOAA/NCEI OISST History
                  </strong>


                  <span>

                    Recent daily surface
                    temperature context
